...
const allDoublePanas: Record<string, string[]> = {
    '1': ["100", "119", "155", "227", "335", "399", "488", "566", "677"],
    '2': ["200", "110", "129", "165", "228", "336", "499", "589", "678"],
    '3': ["300", "111", "120", "139", "229", "265", "337", "489", "580"],
    '4': ["400", "112", "149", "220", "239", "338", "446", "555", "680"],
    '5': ["500", "113", "122", "159", "249", "339", "447", "550", "699"],
    '6': ["600", "114", "123", "169", "222", "330", "448", "556", "790"],
    '7': ["700", "115", "124", "133", "179", "269", "388", "449", "557"],
    '8': ["800", "116", "125", "134", "189", "224", "279", "332", "440"],
    '9': ["900", "117", "126", "135", "144", "289", "379", "478", "559"],
    '0': ["190", "280", "370", "460", "555", "244", "299", "389", "668"],
};
...
export default function DoublePanaPage() {
    ...
    const form = useForm<FormValues>({
        ...
        defaultValues: {
            bids: panasForSelectedDigit.map(pana => ({ pana, points: undefined })),
        },
        mode: "onChange"
    });
    ...
    useEffect(() => {
        const newFields = panasForSelectedDigit.map(pana => ({
            pana,
            points: form.getValues('bids').find(b => b.pana === pana)?.points
        }));
        replace(newFields);
    }, [selectedDigit, panasForSelectedDigit, replace, form]);
    ...
    const handleAddAllBids = () => {
        ...
        const resetData = panasForSelectedDigit.map(pana => ({ pana, points: undefined }));
        replace(resetData);
