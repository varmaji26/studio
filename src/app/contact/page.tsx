...
export default function ContactPage() {
    ...
    return (
        <div className="dark min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-background text-foreground pb-28">
            ...
            <div className="max-w-md mx-auto p-4 sm:p-6 pt-2">
                <div className="mb-6">
                ...
                <div className="space-y-4">
                    {settings.callSupportNumber && (
                        <Button
                            className="w-full h-12 bg-red-500 text-white hover:bg-red-600 flex items-center justify-center gap-2 text-base"
                     ...
                     {settings.whatsappNumber && (
                        <Button
                            className="w-full h-12 bg-green-500 text-white hover:bg-green-600 flex items-center justify-center gap-2 text-base"
                    ...
                    {settings.telegramLink && (
                         <Button
                            className="w-full h-12 bg-blue-500 text-white hover:bg-blue-600 flex items-center justify-center gap-2 text-base"
