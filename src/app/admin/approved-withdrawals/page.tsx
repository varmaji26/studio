...
import { collection, query, onSnapshot, doc, DocumentData, getDoc, where } from 'firebase/firestore';
    ...
    return (
        <Card className="bg-card/80 border-white/10 shadow-lg">
            <CardHeader>
                ...
                <CardDescription>View all approved withdrawals from users.</CardDescription>
            </CardHeader>
            <CardContent>
